...
# create new namespace/biodatabase
db = server.new_database("imgt-hla-test0", description="IMGT/HLA test 0")
print "Created new database"
server.commit()

handle = open("hla-fix.dat", "rU")
count = db.load(SeqIO.parse(handle, "embl"))

...
/**
 * Register genotypes task.
 */
public final class RegisterGenotypes extends AbstractRegisterTask {
    private final GlClient client;
    private static final String USAGE = "gl-register-genotypes --namespace http://localhost:8080/gl [-g glstrings.txt] [-i identifiers.txt]";


    /**
     * Create a new register genotypes task.
     *
     * @param client gl client, must not be null
     */
    public RegisterGenotypes(final GlClient client) {
     ...
     */
    public RegisterGenotypes(final GlClient client, final File glstringFile, final File identifierFile) {
    ...
    public static final void main(final String[] args) {
        ...
        try
        {
            ...
            if (help.wasFound()) {
                ...
                new RegisterGenotypes(client, glstringFile.getValue(), identifierFile.getValue()).run();
            }
        }

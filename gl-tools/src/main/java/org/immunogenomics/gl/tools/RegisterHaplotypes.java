...
public final class RegisterHaplotypes extends AbstractRegisterTask {
    ...
    private static final String USAGE = "gl-register-haplotypes --namespace http://localhost:8080/gl [-g glstrings.txt] [-i identifiers.txt]";
     ...
     */
    public RegisterHaplotypes(final GlClient client) {
     ...
     */
    public RegisterHaplotypes(final GlClient client, final File glstringFile, final File identifierFile) {
    ...
    public static final void main(final String[] args) {
        ...
        try
        {
            ...
            if (help.wasFound()) {
                ...
                new RegisterHaplotypes(client, glstringFile.getValue(), identifierFile.getValue()).run();
            }
        }

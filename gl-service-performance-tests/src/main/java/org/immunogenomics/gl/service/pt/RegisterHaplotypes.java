 ...
 * Register haplotypes.
 */
public final class RegisterHaplotypes extends PartitioningRegisterTask {
    private static final int DEFAULT_N = 2;
    private static final String USAGE = "java RegisterHaplotypes --namespace http://localhost:8080/gl [-n 4] [-g glstrings.txt]";
     ...
     */
    public RegisterHaplotypes(final String ns, final int n) {
        this(ns, n, null);
    }
     ...
     * @param glstringFile glstring file
     */
    public RegisterHaplotypes(final String ns, final int n, final File glstringFile) {
        super(ns, "haplotype", n, glstringFile);
    }
    ...
    public static final void main(final String[] args) {
        ...
        try
        {
            ...
            if (help.wasFound()) {
                ...
                new RegisterHaplotypes(namespace.getValue(), n, glstringFile.getValue()).run();
            }
        }

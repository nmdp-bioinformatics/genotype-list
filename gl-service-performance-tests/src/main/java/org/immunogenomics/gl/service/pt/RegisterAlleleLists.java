 ...
 */
public final class RegisterAlleleLists extends PartitioningRegisterTask {
    private static final int DEFAULT_N = 2;
    private static final String USAGE = "java RegisterAlleleLists --namespace http://localhost:8080/gl [-n 4] [-g glstrings.txt]";
     ...
     */
    public RegisterAlleleLists(final String ns, final int n) {
        this(ns, n, null);
    }
     ...
     */
    public RegisterAlleleLists(final String ns, final int n, final File glstringFile) {
        super(ns, "allele-list", n, glstringFile);
    }
    ...
    public static final void main(final String[] args) {
        ...
        try
        {
            ...
            if (help.wasFound()) {
                ...
                new RegisterAlleleLists(namespace.getValue(), n, glstringFile.getValue()).run();
            }
        }

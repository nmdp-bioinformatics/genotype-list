 ...
 * Register loci.
 */
public final class RegisterLoci extends PartitioningRegisterTask {
    private static final int DEFAULT_N = 2;
    private static final String USAGE = "java RegisterLoci --namespace http://localhost:8080/gl [-n 4] [-g glstrings.txt]";
     ...
     */
    public RegisterLoci(final String ns, final int n) {
        this(ns, n, null);
    }
     ...
     */
    public RegisterLoci(final String ns, final int n, final File glstringFile) {
        super(ns, "locus", n, glstringFile);
    }
    ...
    public static final void main(final String[] args) {
        ...
        try
        {
            ...
            if (help.wasFound()) {
                ...
                new RegisterLoci(namespace.getValue(), n, glstringFile.getValue()).run();
            }
        }

...
public final class RegisterMultilocusUnphasedGenotypes extends PartitioningRegisterTask {
     ...
     * @param glstringFile glstring file
     */
    public RegisterMultilocusUnphasedGenotypes(final String ns, final int n, final File glstringFile) {
        super(ns, "multilocus-unphased-genotype", n, glstringFile);
    }
    ...
    public static final void main(final String[] args) {
        ...
        try
        {
            ...
            if (help.wasFound()) {
                ...
                new RegisterMultilocusUnphasedGenotypes(namespace.getValue(), n, glstringFile.getValue()).run();
            }
        }

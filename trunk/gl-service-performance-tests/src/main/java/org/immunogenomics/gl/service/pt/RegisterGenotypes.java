 ...
 * Register genotypes.
 */
public final class RegisterGenotypes extends PartitioningRegisterTask {
    private static final int DEFAULT_N = 2;
    private static final String USAGE = "java RegisterGenotypes --namespace http://localhost:8080/gl [-n 4] [-g glstrings.txt]";
     ...
     */
    public RegisterGenotypes(final String ns, final int n) {
        this(ns, n, null);
    }
     ...
     */
    public RegisterGenotypes(final String ns, final int n, final File glstringFile) {
        super(ns, "genotype", n, glstringFile);
    }
    ...
    public static final void main(final String[] args) {
        ...
        try
        {
            ...
            if (help.wasFound()) {
                ...
                new RegisterGenotypes(namespace.getValue(), n, glstringFile.getValue()).run();
            }
        }

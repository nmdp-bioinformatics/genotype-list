...
/**
 * IMGT/HLA version 3.8.0 nomenclature.
 */
public final class ImgtHla3_8_0 extends ClasspathNomenclature {

    @Inject
    public ImgtHla3_8_0(final GlstringResolver glstringResolver,
                         final IdResolver idResolver,
                         final GlRegistry glRegistry) {
        super("imgt-hla-3.8.0.txt", glstringResolver, idResolver, glRegistry);
    }

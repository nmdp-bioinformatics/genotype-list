...
/**
 * IMGT/HLA version 2.14.1 nomenclature.
 */
public final class ImgtHla2_14_1 extends ClasspathNomenclature {

    @Inject
    public ImgtHla2_14_1(final GlstringResolver glstringResolver,
                         final IdResolver idResolver,
                         final GlRegistry glRegistry) {
        super("imgt-hla-2.14.1.txt", glstringResolver, idResolver, glRegistry);
    }

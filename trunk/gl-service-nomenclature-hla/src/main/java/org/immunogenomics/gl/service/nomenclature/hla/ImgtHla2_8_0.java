...
/**
 * IMGT/HLA version 2.8.0 nomenclature.
 */
public final class ImgtHla2_8_0 extends ClasspathNomenclature {

    @Inject
    public ImgtHla2_8_0(final GlstringResolver glstringResolver,
                         final IdResolver idResolver,
                         final GlRegistry glRegistry) {
        super("imgt-hla-2.8.0.txt", glstringResolver, idResolver, glRegistry);
    }

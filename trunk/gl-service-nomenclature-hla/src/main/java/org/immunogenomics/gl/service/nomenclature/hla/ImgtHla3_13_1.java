...
/**
 * IMGT/HLA version 3.13.1 nomenclature.
 */
public final class ImgtHla3_13_1 extends ClasspathNomenclature {

    @Inject
    public ImgtHla3_13_1(final GlstringResolver glstringResolver,
                         final IdResolver idResolver,
                         final GlRegistry glRegistry) {
        super("imgt-hla-3.13.1.txt", glstringResolver, idResolver, glRegistry);
    }

...
/**
 * IMGT/HLA version 2.19.0 nomenclature.
 */
public final class ImgtHla2_19_0 extends ClasspathNomenclature {

    @Inject
    public ImgtHla2_19_0(final GlstringResolver glstringResolver,
                         final IdResolver idResolver,
                         final GlRegistry glRegistry) {
        super("imgt-hla-2.19.0.txt", glstringResolver, idResolver, glRegistry);
    }

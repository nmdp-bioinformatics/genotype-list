...
/**
 * IMGT/HLA version 2.26.0 nomenclature.
 */
public final class ImgtHla2_26_0 extends ClasspathNomenclature {

    @Inject
    public ImgtHla2_26_0(final GlstringResolver glstringResolver,
                         final IdResolver idResolver,
                         final GlRegistry glRegistry) {
        super("imgt-hla-2.26.0.txt", glstringResolver, idResolver, glRegistry);
    }

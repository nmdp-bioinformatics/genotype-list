...
/**
 * Servlet Filter helper class for <a href="http://tools.ietf.org/html/rfc6750">OAuth 2.0 Bearer Token</a>.
 */
public class BearerTokenFilterHelper {
	...
	public BearerTokenFilterHelper(TokenValidator tokenValidator,
			ScopeEvaluator scopeEvaluator, Authorizer authorizer) {
		super();
	...
	/** Extract the Bearer token from the request's Authenticate header and validate it. */

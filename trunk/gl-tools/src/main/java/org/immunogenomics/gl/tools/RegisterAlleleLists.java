...
public final class RegisterAlleleLists extends AbstractRegisterTask {
    ...
    private static final String USAGE = "gl-register-allele-lists --namespace http://localhost:8080/gl [-g glstrings.txt] [-i identifiers.txt]";
     ...
     */
    public RegisterAlleleLists(final GlClient client) {
     ...
     */
    public RegisterAlleleLists(final GlClient client, final File glstringFile, final File identifierFile) {
    ...
    public static final void main(final String[] args) {
        ...
        try
        {
            ...
            if (help.wasFound()) {
                ...
                new RegisterAlleleLists(client, glstringFile.getValue(), identifierFile.getValue()).run();
            }
        }

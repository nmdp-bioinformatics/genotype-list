...
public final class RegisterMultilocusUnphasedGenotypes extends AbstractRegisterTask {
    ...
    private static final String USAGE = "gl-register-multilocus-unphased-genotypes --namespace http://localhost:8080/gl [-g glstrings.txt] [-i identifiers.txt]";
     ...
     */
    public RegisterMultilocusUnphasedGenotypes(final GlClient client) {
     ...
     */
    public RegisterMultilocusUnphasedGenotypes(final GlClient client, final File glstringFile, final File identifierFile) {
    ...
    public static final void main(final String[] args) {
        ...
        try
        {
            ...
            if (help.wasFound()) {
                ...
                new RegisterMultilocusUnphasedGenotypes(client, glstringFile.getValue(), identifierFile.getValue()).run();
            }
        }

...
/**
 * Unit test for JedisModule.
 */
public final class JedisModuleTest {
    private JedisModule jedisModule;

    @Before
    public void setUp() {
        jedisModule = new JedisModule();
    }

    @Test
    public void testConstructor() {
        assertNotNull(jedisModule);
    }

    @Test
    public void testJedisModule() {
        Injector injector = Guice.createInjector(new TestModule(), new IdModule(), jedisModule);

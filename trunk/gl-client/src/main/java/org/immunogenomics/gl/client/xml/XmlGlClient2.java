 ...
 */
public final class XmlGlClient2 extends CacheGlClient {
     ...
     */
    //@Inject
    public XmlGlClient2(@Namespace final String namespace) {
    ...
    public Locus getLocus(final String identifier) {
        ...
        try {
            ...
            locus = toLocus((org.immunogenomics.gl.client.xml.jaxb.Locus) unmarshaller.unmarshal(inputStream));
    ...
    public Allele getAllele(final String identifier) {
        ...
        try {
            inputStream = get(identifier + ".xml");
            Unmarshaller unmarshaller = jaxbContext.createUnmarshaller();
            allele = toAllele((org.immunogenomics.gl.client.xml.jaxb.Allele) unmarshaller.unmarshal(inputStream));
    ...
    public AlleleList getAlleleList(final String identifier) {
        ...
        try {
            inputStream = get(identifier + ".xml");
            Unmarshaller unmarshaller = jaxbContext.createUnmarshaller();
            return toAlleleList((org.immunogenomics.gl.client.xml.jaxb.AlleleList) unmarshaller.unmarshal(inputStream));
        }
        catch (UnmarshalException ue) {
    ...
    public Haplotype getHaplotype(final String identifier) {
        ...
        try {
            inputStream = get(identifier + ".xml");
            Unmarshaller unmarshaller = jaxbContext.createUnmarshaller();
            return toHaplotype((org.immunogenomics.gl.client.xml.jaxb.Haplotype) unmarshaller.unmarshal(inputStream));
        }
        catch (UnmarshalException ue) {
    ...
    public Genotype getGenotype(final String identifier) {
        ...
        try {
            inputStream = get(identifier + ".xml");
            Unmarshaller unmarshaller = jaxbContext.createUnmarshaller();
            return toGenotype((org.immunogenomics.gl.client.xml.jaxb.Genotype) unmarshaller.unmarshal(inputStream));
        }
        catch (UnmarshalException ue) {
    ...
    public GenotypeList getGenotypeList(final String identifier) {
        ...
        try {
            inputStream = get(identifier + ".xml");
            Unmarshaller unmarshaller = jaxbContext.createUnmarshaller();
            return toGenotypeList((org.immunogenomics.gl.client.xml.jaxb.GenotypeList) unmarshaller.unmarshal(inputStream));
        }
        catch (UnmarshalException ue) {
    ...
    public MultilocusUnphasedGenotype getMultilocusUnphasedGenotype(final String identifier) {
        ...
        try {
            inputStream = get(identifier + ".xml");
            Unmarshaller unmarshaller = jaxbContext.createUnmarshaller();
            return toMultilocusUnphasedGenotype((org.immunogenomics.gl.client.xml.jaxb.MultilocusUnphasedGenotype) unmarshaller.unmarshal(inputStream));
        }
        catch (UnmarshalException ue) {

...
import org.immunogenomics.gl.imgt.db.dao.intf.IndelDaoIntf;
 ...
 *
 */
public class IndelDaoImpl extends BaseDao implements IndelDaoIntf {

	/* (non-Javadoc)
	 * @see org.immunogenomics.gl.imgt.db.dao.intf.IndelDaoIntf#getIndels()
	 */
	@SuppressWarnings("unchecked")
	public List<IndelDto> getIndels() {

		EntityManager em = getEntityManager();
		List<IndelDto> results = null;

        Query query = em.createNamedQuery("getIndels");

        try{

        	results = (List<IndelDto>)query.getResultList();

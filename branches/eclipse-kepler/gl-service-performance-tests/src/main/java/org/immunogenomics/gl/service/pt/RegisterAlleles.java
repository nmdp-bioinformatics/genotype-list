 ...
 * Register alleles.
 */
public final class RegisterAlleles extends PartitioningRegisterTask {
    private static final int DEFAULT_N = 2;
    private static final String USAGE = "java RegisterAlleles --namespace http://localhost:8080/gl [-n 4] [-g glstrings.txt]";
     ...
     */
    public RegisterAlleles(final String ns, final int n) {
        this(ns, n, null);
    }
     ...
     */
    public RegisterAlleles(final String ns, final int n, final File glstringFile) {
        super(ns, "allele", n, glstringFile);
    }
    ...
    public static final void main(final String[] args) {
        ...
        try
        {
            ...
            if (help.wasFound()) {
                ...
                new RegisterAlleles(namespace.getValue(), n, glstringFile.getValue()).run();
            }
        }

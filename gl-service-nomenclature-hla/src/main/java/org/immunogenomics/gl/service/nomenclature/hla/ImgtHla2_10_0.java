...
/**
 * IMGT/HLA version 2.10.0 nomenclature.
 */
public final class ImgtHla2_10_0 extends ClasspathNomenclature {

    @Inject
    public ImgtHla2_10_0(final GlstringResolver glstringResolver,
                         final IdResolver idResolver,
                         final GlRegistry glRegistry) {
        super("imgt-hla-2.10.0.txt", glstringResolver, idResolver, glRegistry);
    }

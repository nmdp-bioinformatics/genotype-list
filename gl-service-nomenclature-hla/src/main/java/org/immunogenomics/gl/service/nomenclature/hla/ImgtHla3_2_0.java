...
/**
 * IMGT/HLA version 3.2.0 nomenclature.
 */
public final class ImgtHla3_2_0 extends ClasspathNomenclature {

    @Inject
    public ImgtHla3_2_0(final GlstringResolver glstringResolver,
                         final IdResolver idResolver,
                         final GlRegistry glRegistry) {
        super("imgt-hla-3.2.0.txt", glstringResolver, idResolver, glRegistry);
    }

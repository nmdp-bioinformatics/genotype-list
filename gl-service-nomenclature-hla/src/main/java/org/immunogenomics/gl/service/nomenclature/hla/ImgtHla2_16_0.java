...
/**
 * IMGT/HLA version 2.16.0 nomenclature.
 */
public final class ImgtHla2_16_0 extends ClasspathNomenclature {

    @Inject
    public ImgtHla2_16_0(final GlstringResolver glstringResolver,
                         final IdResolver idResolver,
                         final GlRegistry glRegistry) {
        super("imgt-hla-2.16.0.txt", glstringResolver, idResolver, glRegistry);
    }

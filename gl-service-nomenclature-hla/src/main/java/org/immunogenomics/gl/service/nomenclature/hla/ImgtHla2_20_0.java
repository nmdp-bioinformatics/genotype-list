...
/**
 * IMGT/HLA version 2.20.0 nomenclature.
 */
public final class ImgtHla2_20_0 extends ClasspathNomenclature {

    @Inject
    public ImgtHla2_20_0(final GlstringResolver glstringResolver,
                         final IdResolver idResolver,
                         final GlRegistry glRegistry) {
        super("imgt-hla-2.20.0.txt", glstringResolver, idResolver, glRegistry);
    }

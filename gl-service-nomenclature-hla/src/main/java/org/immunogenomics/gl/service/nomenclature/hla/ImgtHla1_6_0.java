...
/**
 * IMGT/HLA version 1.6.0 nomenclature.
 */
public final class ImgtHla1_6_0 extends ClasspathNomenclature {

    @Inject
    public ImgtHla1_6_0(final GlstringResolver glstringResolver,
                         final IdResolver idResolver,
                         final GlRegistry glRegistry) {
        super("imgt-hla-1.6.0.txt", glstringResolver, idResolver, glRegistry);
    }

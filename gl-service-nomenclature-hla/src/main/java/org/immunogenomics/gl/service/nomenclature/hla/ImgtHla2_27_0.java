...
/**
 * IMGT/HLA version 2.27.0 nomenclature.
 */
public final class ImgtHla2_27_0 extends ClasspathNomenclature {

    @Inject
    public ImgtHla2_27_0(final GlstringResolver glstringResolver,
                         final IdResolver idResolver,
                         final GlRegistry glRegistry) {
        super("imgt-hla-2.27.0.txt", glstringResolver, idResolver, glRegistry);
    }

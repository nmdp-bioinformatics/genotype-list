...
/**
 * IMGT/HLA version 2.12.0 nomenclature.
 */
public final class ImgtHla2_12_0 extends ClasspathNomenclature {

    @Inject
    public ImgtHla2_12_0(final GlstringResolver glstringResolver,
                         final IdResolver idResolver,
                         final GlRegistry glRegistry) {
        super("imgt-hla-2.12.0.txt", glstringResolver, idResolver, glRegistry);
    }

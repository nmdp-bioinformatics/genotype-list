...
/**
 * IMGT/HLA version 1.5.0 nomenclature.
 */
public final class ImgtHla1_5_0 extends ClasspathNomenclature {

    @Inject
    public ImgtHla1_5_0(final GlstringResolver glstringResolver,
                         final IdResolver idResolver,
                         final GlRegistry glRegistry) {
        super("imgt-hla-1.5.0.txt", glstringResolver, idResolver, glRegistry);
    }

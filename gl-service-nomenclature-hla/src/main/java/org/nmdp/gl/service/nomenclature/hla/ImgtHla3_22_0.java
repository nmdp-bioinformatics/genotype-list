...
/**
 * IMGT/HLA version 3.22.0 nomenclature.
 */
public final class ImgtHla3_22_0 extends ClasspathNomenclature {

    @Inject
    public ImgtHla3_22_0(final GlstringResolver glstringResolver,
                         final IdResolver idResolver,
                         final GlRegistry glRegistry) {
        super("imgt-hla-3.22.0.txt", glstringResolver, idResolver, glRegistry);
    }
